...
<template>
	<div class="h-full p-[1px] bg-[var(--bc)] relative">
		...
		<aside data-tauri-drag-region
			...
			<div class="w-full relative space-y-1 electron-no-drag" data-tauri-drag-region>
		...
		<!-- close button -->
		<div class="absolute right-0 top-0 z-40 px-4 py-2 hover:bg-[#c42b1c] group electron-no-drag" @click="closeWindow()">
